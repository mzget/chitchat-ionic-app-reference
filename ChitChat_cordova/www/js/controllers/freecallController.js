...
//	$timeout(countUp, 1000);
	...
	$scope.$on('$ionicView.enter', function () { //This is fired twice in a row
		...
		if( self.currentRoom.members[0].id != myprofile._id )
		{
			var roomowner = allMembers[self.currentRoom.members[0].id];
		}else{
			var roomowner = allMembers[self.currentRoom.members[1].id];
		}
		
		console.log( '\n\n\n\n\n\n\n\nRoomowner' );
		console.log( roomowner );
		$scope.roomowner = roomowner;
	});
