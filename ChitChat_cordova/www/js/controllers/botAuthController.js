(function () {
    ...
    angular
        ...
        .controller('botAuthController', botAuthController)

    function botAuthController($location, $ionicPopup, $ionicLoading, $state, $localStorage, $ionicModal, $ionicTabsDelegate, $scope, $rootScope,
        $cordovaSpinnerDialog, $cordovaDialogs, $cordovaNetwork,
        networkService, chatslogService, dbAccessService, sharedObjectService, botFactory) {

        /* jshint validthis:true */
        var self = this;
        self.title = 'botAuthController';
        var registrationId = "";
        $ionicTabsDelegate.showBar(false);

        ionic.Platform.ready(function () {
            console.log(self.title + " : ionic ready.");
            ...
            setTimeout(function () {
                ...
                main.onMyProfileReadyListener = function (dataManager) {
                    ...
                    //@ bot navigator.
                    location.href = "#/tab/bot";
                    botFactory.getData().fireChatInRoom(dataManager.myProfile._id);
                };


                //@Bot.
                botFactory.init();
                self.bot = botFactory.getBot();
        ...
        function activate() {
            console.warn('activate: ' + self.title);
        ...
        function onReadyToSigning() {
            ...
            if (!authen.token) {
                ...
                //@ Bot...
                var email = self.bot.name;
                var password = self.bot.pass;
